...
import {
    Platform, StyleSheet, Text, ListView, Alert, View, TextInput, TouchableOpacity, Image, Dimensions
} from 'react-native';
...
class FuzzyQuery extends Component {
    ...
    render() {
        return (
                <View style={{flex: 1,marginTop:10, width: width / 1.8, height: 40,position: 'absolute'}}>
                    ...
                    {this.state.showListView ? <ListView
                        style={{
                            backgroundColor: 'white', left: 30, top:40, width: width/1.6, height: 200, position: 'absolute',
...
const mapStateToProps = (state) => {
    return {
        ...
        currentText: state.RS_Inquiry.payload
    };
